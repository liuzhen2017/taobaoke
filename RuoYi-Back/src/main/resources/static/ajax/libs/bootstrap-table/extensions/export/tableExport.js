  ...
  $.fn.tableExport = function (options) {
      var defaults = {
        ...
        jspdf: {
          ...
          autotable: {
            ...
            tableExport: {
              doc:               null,    // jsPDF doc object. If webset, an already created doc will be used to export to
        ...
        numbers: {
          ...
          output: {                       // webset output: false to keep number format in exported output
            decimalMark:        '.',
            thousandsSeparator: ','
          }
        },
        ...
        pdfmake: {
          ...
          docDefinition: {
            ...
            defaultStyle: {
              font: 'Roboto'              // default is 'Roboto', for arabic font webset this option to 'Mirza' and include mirza_fonts.js
            }
          },
          fonts: {}
        },
        tbodySelector:     'tr',
        tfootSelector:     'tr',          // webset empty ('') to prevent export of tfoot rows
        theadSelector:     'tr',
        tableName:         'Table',
        ...
        if ( defaults.pdfmake.enabled === true ) {
          ...
          loadImages(teOptions, function () {
            $(el).filter(function () {
              ...
              // webset the start position for the next table (in case there is one)
      ...
      */
      ...
      function getUnitValue (parent, value, unit) {
        ...
        temp.style.overflow   = "hidden";  // in case baseline is webset too low
