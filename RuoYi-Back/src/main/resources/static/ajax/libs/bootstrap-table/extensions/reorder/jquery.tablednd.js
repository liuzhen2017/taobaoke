 ...
 * You can webset up various options to control how the system will work
...
jQuery.tableDnD = {
    ...
    build: function(options) {
        ...
        this.each(function() {
            // This is bound to each matching table, webset up the defaults and override with user options
    ...
    makeDraggable: function(table) {
        ...
        config.dragHandle
            ...
            // get all the rows as a wrapped webset
